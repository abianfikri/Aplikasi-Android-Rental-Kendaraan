...
public class DetailPenyewaMotorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_penyewa_motor);
        ...
        progressDialog = new ProgressDialog(DetailPenyewaMotorActivity.this);
        ...
        if(intent != null){
            ...
            harga.setText("Rp " +intent.getStringExtra("hargaMotor"));
